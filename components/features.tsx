...
function WhatsAppIcon({ className, ...props }: LucideProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
const features: {
...
}[] = [
  {
    ...
    desc: 'Confirmaciones y recordatorios que reducen las ausencias sin que muevas un dedo. Somos Tech Provider oficial de Meta.',
  },
  {
    icon: CreditCard,
